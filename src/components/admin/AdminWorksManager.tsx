        ...
        <div className="bg-white text-[#1F2937] rounded-3xl p-7 sm:p-9 border-2 border-[#6C63FF] shadow-xl relative animate-fade-up">
          <div className="flex items-center justify-between pb-5 border-b border-[#E5E7EB] mb-7">
            <h4 className="text-lg sm:text-xl font-black text-[#1F2937] flex items-center gap-2.5">
              ...
              <span>{editingWork ? `تعديل النموذج: (${editingWork.title})` : "إضافة نموذج عمل جديد خلال أقل من دقيقة (بسيط وسلس):"}</span>
            </h4>
            <button 
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  type="text"
                  placeholder="مثال: 89 ريال، 150 ريال، أو حسب المواصفات"
                  value={price}
            ...
            <div className="space-y-2">
              ...
              <textarea
                required
                rows={4}
                placeholder="اكتب نبذة عن الملف وما يحتويه من أقسام ليعزز اهتمام قادة التعليم بالطلب..."
                value={description}
